...
exports.importStatementSnippet = void 0;
const importPath = require("../import-snippets");
const _1 = require(".");
/**
...
function importStatementSnippet(relativePath, fromFilepath, toFilepath) {
    switch ((0, _1.getFileExt)(toFilepath)) {
        case '.js': {
...
exports.importStatementSnippet = importStatementSnippet;
